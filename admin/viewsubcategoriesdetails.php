            ...
            <div class="breadcrumb-custom">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="category.php?id=<?php echo $subcategory['category_id']; ?>" class="text-decoration-none"><?php echo htmlspecialchars($subcategory['category_name']); ?></a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="contact-info">
                    ...
                    <div class="mt-4">
                        <a href="contact.php?property=<?php echo $subcategory_id; ?>" class="btn btn-light w-100">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        ...
                        ?>
                            <a href="showsubcategorie.php?id=<?php echo $item['id']; ?>" class="text-decoration-none">
                                <div class="d-flex align-items-center p-3 border-bottom">
                                    <div class="flex-shrink-0" style="width: 70px; height: 70px; overflow: hidden; border-radius: 8px;">
                                        <img src="<?php echo htmlspecialchars($itemPhoto); ?>" 
